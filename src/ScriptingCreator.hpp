...
{
private:
    static std::unordered_map<std::string, std::pair<std::string, std::string>> ClassMap;
    static std::unordered_map<std::string, std::string>  MethodMap;
    static std::unordered_map<std::string, std::string>  FunctionMap;
public:
    ScriptingCreator() {}
    static std::unordered_map<std::string, std::pair<std::string, std::string>>& GetClassMap() { return ClassMap; }
    static std::unordered_map<std::string, std::string>& GetMethodMap() { return MethodMap; }
